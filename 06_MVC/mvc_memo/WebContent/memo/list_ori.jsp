			...
			<c:forEach var="vo" items="${list}">
				<li>
					<div class="commentTop">
						...
						<div class="button">
							<a href="memo.do?cmd=modifyForm"><button class="modifyBtn btn_blue">수정</button></a>
							<button class="deleteBtn btn_red">삭제</button>
						</div>
					</div>
					<form id="commentForm" class="commentForm" name="" action=""
						...
						<div>
							<fieldset>
								...
								<div class="commentFormTop">
									<strong>비밀번호 :</strong> <input id="comment_password"
										name="comment_password" value="" type="password">
								</div>
								<div class="view">
